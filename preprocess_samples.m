function neighbourhood = preprocess_samples(bin_import, k, boxsize, max_samples_box, spp)
    ...
    neighbourhood = struct( 'color', getFeatureForIndex(bin_import, 7, N), ...
                    ...
                    'features', [getFeatureForIndex(bin_import, 13, N); ...
                                getFeatureForIndex(bin_import, 16, N); ...
                                getFeatureForIndex(bin_import, 19, N); ...
                                getFeatureForIndex(bin_import, 28, N); ...
                                getFeatureForIndex(bin_import, 34, N); ...
                                getFeatureForIndex(bin_import, 21, N)], ...
